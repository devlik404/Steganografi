...
public class extractAndDecrypt {
    ...
    public void extractAndDecryptService(MultipartFile imageFile, String password) throws Exception {
        ...
        extracted.setfile_name(originalFileName);
        extracted.setencrypted_file_name("extracted_from_" + imageFile.getOriginalFilename());
        extracted.setdecrypted_file_name(decryptedFileName);
